...
esint8 sd_Init(hwInterface *iface)
{
	...
	DEBUG_PRINTF("DEBUG in File: %s : line %d reset response %02x\n", __FILE__ , __LINE__, resp);
#endif
...
#ifdef FS_DEBUG_DEFINE
  DEBUG_PRINTF("DEBUG in File: %s : line %d\n", __FILE__ , __LINE__);
#endif
...
#ifdef FS_DEBUG_DEFINE	
	DEBUG_PRINTF("DEBUG in File: %s : line %d initialization response = %d i=%d\n", __FILE__ , __LINE__,resp,i);
#endif
...
#ifdef FS_DEBUG_DEFINE
	DEBUG_PRINTF("DEBUG in File: %s : line %d sd state = %d \n", __FILE__ , __LINE__,value);
#endif
